  ...
  return (
    <div>
      <section>
        ...
        {!loading && (
          <>
            <PopularGrid popuInfo={popularInfo} popuInfoApi={popularRecipes} />
...
const popularInfo = [
  {
    description:
      " A creamy and comforting pasta dish made with rich sauce, parmesan cheese, and perfectly cooked noodles.",
  },
  {
    description:
      "A flavorful stir-fried noodle dish packed with tender chicken fresh vegetables, and a savory soy-based sauce.",
  },
  {
    description:
      " A vibrant and refreshing salad combining crisp vegetables, herbs, and a light citrus dressing.",
  },
];
